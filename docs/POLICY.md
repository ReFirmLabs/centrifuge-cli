...
--generate-sarif : output should be in sarif format
...
centrifuge report --ufid=<REPORT ID> check-policy --policy-yaml my-policy.yml --generate-sarif --report-url https://centrifuge.refirmlabs.com
